...
public class ArticleItem4Fragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(articleList!=null && articleList.size()>0){
            view =LayoutInflater.from(container.getContext()).inflate(R.layout.fragment_article_item4,container,false);
    ...
    public void initData() {
        articleList = ArticleDao.getByTypeArticleFromLitePal("4",articleList);
    }
