                ...
                builder.setIcon(R.drawable.share).setTitle("分享")
                        .setItems(items, new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                if(which==0){
                                    ((MainActivity)(context)).shareText("美文："+ article.getTitle(),0);
                                }else if(which==1){
                                    ((MainActivity)(context)).shareText("美文："+ article.getTitle(),1);
                                }else if(which==2){
                                    ((MainActivity)(context)).shareToQQ("美文："+ article.getTitle());
                                }else if(which==3){
                                    ((MainActivity)(context)).shareToQZone("美文："+ article.getTitle());
                                }
                            }
                        });
                builder.create().show();
